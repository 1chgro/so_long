...
/*   Updated: 2025/01/26 06:28:16 by olachgue         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	load_images(t_game *game)
{
	game->empty.img = mlx_xpm_file_to_image(game->mlx,
			"utils/sprites/empty.xpm", &game->empty.width, &game->empty.height);
	game->exit.img = mlx_xpm_file_to_image(game->mlx,
			"utils/sprites/exit.xpm", &game->exit.width, &game->exit.height);
	game->player.img = mlx_xpm_file_to_image(game->mlx,
			"utils/sprites/player1.xpm", &game->player.width,
			&game->player.height);
	game->wall.img = mlx_xpm_file_to_image(game->mlx,
			"utils/sprites/wall.xpm", &game->wall.width, &game->wall.height);
	game->collectible.img = mlx_xpm_file_to_image(game->mlx,
			"utils/sprites/coin5.xpm", &game->collectible.width,
