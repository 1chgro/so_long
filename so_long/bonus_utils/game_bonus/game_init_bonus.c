...
/*   Updated: 2025/01/22 06:33:16 by olachgue         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	put_tile(t_game *game, char tile, int x, int y)
{
	...
	{
		current_sprite = game->coin_anim.coins[game->coin_anim.current_frame];
		mlx_put_image_to_window(game->mlx, game->win, current_sprite.img,
